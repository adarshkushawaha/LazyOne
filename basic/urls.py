...
urlpatterns = [
    ...
    path('profile/', views.profile_view, name='profile'), # This is for the logged-in user's own profile
    path('user/<int:user_id>/', views.user_profile_view, name='user_profile'), # This is for viewing other users' profiles
